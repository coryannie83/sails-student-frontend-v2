...
module.exports = {
  ...
  read: function (req, res) {
    ...
    client.get(endpoint, function (data, response) {
        return res.view(view, {student_class: data});
    }).on('error', function (err) {
        return res.view(view, {error: { message: "There was an error getting the student class records."}});
    });
  ...
  update: function (req, res) {
    ...
    let student_class = req.body.student_class_id;
    ...
    client.put(endpoint + "/" + student_class, args, function (data, response) {
