 ...
 *
 * @description :: Server-side logic for managing major_classs
...
//this allows user to have nulls on form
...
module.exports = {
  ...
  read: function (req, res) {
    ...
    client.get(endpoint, function (data, response) {
        ...
        return res.view(view, {error: { message: "There was an error getting the major and class information"}});
    });
  ...
  update: function (req, res) {
    ...
    let major_class_id = req.body.major_class_Id;
    ...
    client.put(endpoint + "/" + major_class_id, args, function (data, response) {
