...
module.exports = {
  ...
  read: function (req, res) {
    ...
    client.get(endpoint, function (data, response) {
        return res.view(view, {assignment: data});
    }).on('error', function (err) {
        return res.view(view, {error: { message: "There was an error getting the asignments"}});
    });
  ...
  update: function (req, res) {
    // copied form assignment, updated to assignment
  ...
  delete: function (req, res) {
    //replaced assignment id with assignment id
