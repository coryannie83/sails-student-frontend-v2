...
module.exports = {
  ...
  read: function (req, res) {
    ...
    client.get(endpoint, function (data, response) {
        return res.view(view, {major: data});
    }).on('error', function (err) {
        return res.view(view, {error: { message: "There was an error getting the major information."}});
    });
  ...
  update: function (req, res) {
    ...
    let major_id = req.body.major_id;
    ...
    client.put(endpoint + "/" + major_id, args, function (data, response) {
